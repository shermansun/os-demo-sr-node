...
<html lang="en">
<head>
    <title>Code coverage report for src/ConfigClusterResolver.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> ConfigClusterResolver.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  buildServiceUrls() {
    ...
    if (serviceUrls) {
      zones.forEach((zone) =&gt; {
        if (<span class="missing-if-branch" title="else path not taken" >E</span>serviceUrls[zone]) {
