...
&nbsp;
  refreshCurrentCluster(callback = <span class="branch-0 cbranch-no" title="branch not covered" >noop) {</span>
...
&nbsp;
  resolveClusterHosts(callback = <span class="branch-0 cbranch-no" title="branch not covered" >noop) {</span>
    const { ec2Region, host, preferSameZone } = this.config.eureka;
    const { metadata } = this.config.instance.dataCenterInfo;
    c</span>onst availabilityZone = metadata ? metadata['availability-zone'] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Aug 03 2016 16:43:14 GMT-0700 (PDT)
</div>
</div>
