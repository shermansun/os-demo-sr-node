...
<html lang="en">
<head>
    <title>Code coverage report for src/aws-metadata.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> aws-metadata.js
    </h1>
    <div class='clearfix'>
    ...
    async.parallel({
      ...
      accountId: callback =&gt; {
        ...
        this.lookupInstanceIdentity((error, identity) =&gt; {
          callback(null, identity ? identity.accountId : <span class="branch-1 cbranch-no" title="branch not covered" >null)</span>;
        });
      }
    }, (error, results) =&gt; {
...
&nbsp;
  lookupMetadataKey(key, callback) {
    request.get({
      ...
      callback(null, (error || response.statusCode !== 200) ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: body);
    });
  }
&nbsp;
  lookupInstanceIdentity(callback) {
    request.get({
      ...
      callback(null, (error || response.statusCode !== 200) ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: JSON.parse(body));
    });
  }
}
&nbsp;</pre></td></tr>
