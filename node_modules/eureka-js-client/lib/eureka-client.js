...
var Eureka = (function () {
  function Eureka(config) {
    ...
    this.config = _deepmerge2['default'](_defaultConfig2['default'], getYaml(_path2['default'].join(cwd, 'eureka-client.yml')));
    this.config = _deepmerge2['default'](this.config, getYaml(_path2['default'].join(cwd, 'eureka-client-' + env + '.yml')));
